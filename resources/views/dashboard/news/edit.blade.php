                    ...
                    <div class="col-lg-8 mt-5">
                        <form method="post" action="/dashboard/news/{{ $news->slug }}" class="mb-5" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"id="title" name="title" accept="" value="{{ old('title') ?? $news->title }}" required>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug') ?? $news->slug }}" readonly>
                            </div>
                            <div class="mb-3">
