                    ...
                    <div>
                        <div class="row align-items-center">
                            <div class="col-md-6 col-6 mb-3 mb-md-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight">News Categories</h1>
                            </div>
                            <!-- Actions -->
                            <div class="col-md-6 col-6 text-md-end  d-flex justify-content-end">
                                <div class="mx-n1">
                                    <a href="/dashboard/categories/create" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                        <span class="pe-2">
        ...
        <main class="py-10 bg-surface-secondary">
            <div class="container-fluid">
                @if (session()->has('success'))
                    <div class="alert alert-success alert-dismissible fade show mb-3 col-lg-6" role="alert">
                        {{ session('success') }}
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                @endif
                <!-- Card stats -->
                <div class="card mb-7 col-lg-6">
                                ...
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a type="button" href="/dashboard/categories/{{ $category->slug }}/edit"
