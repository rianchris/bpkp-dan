                    ...
                    <div>
                        <div class="row align-items-center">
                            <div class="col-md-6 col-6 mb-3 mb-md-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight">All Publikasi</h1>
                            </div>
                            <!-- Actions -->
                            <div class="col-md-6 col-6 text-md-end  d-flex justify-content-end">
                                <div class="mx-n1">
                                    <a href="/dashboard/publikasi/create" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                        <span class="pe-2">
                            ...
                            <tbody>
                                @foreach ($publikasi as $publikasi)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a type="button" href="/dashboard/publikasi/{{ $publikasi->slug }}/edit"
                                                class="btn btn-sm btn-square btn-neutral text-warning-hover">
                                                <i class="bi bi-pencil"></i>
                                            </a>

                                            <form action="/dashboard/publikasi/{{ $publikasi->slug }}" method="post"
                                                class="d-inline">
                                                @method('delete')
                                                @csrf
                                                <button type="submit"
